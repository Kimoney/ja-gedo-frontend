...
export default function HardwareSignupPage() {
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 flex flex-col items-center px-6 py-12">
        <div className="w-full max-w-3xl">
          {/* Title */}
          <h1 className="text-3xl font-bold text-center text-gray-900 mb-8">Hardware</h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {currentStep === 1 && (
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <label htmlFor="hardwareName" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            {currentStep === 2 && (
              <div>
                ...
                <p className="text-gray-600 mb-6">Provide your hardware store address details.</p>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="bg-gray-50 p-4 rounded-md">
                    <h3 className="font-medium mb-2">Hardware Information</h3>
                    <p>Hardware Name: {formData.hardwareName}</p>
                    <p>
                      Contact Person: {formData.firstName} {formData.lastName}
                    </p>
